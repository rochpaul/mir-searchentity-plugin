                ...
                if (that.selectedType === "GND" && options.target === ".personExtended_box") {
                    $person.on("mouseover", function (event) {
                        ...
                        SearchEntity.loadData(lobidUrl, 'json', '', (entityDetails) => {
                            ...
                            // if (entityDetails.fieldOfStudy) {
                            //     console.log(entityDetails.fieldOfStudy.length);
                            // };
                            ...
                            if (entityDetails.geographicAreaCode) {
                                ...
                                /* multiple geographicalAreaCodes */
                            ...
                            if (entityDetails.affiliation) {
                                ...
                                console.log(parsedDetails["affiliation"]);
                            }


                            // parsedDetails["affiliation"] = '';
                            // entityDetails.affiliation.each((affiliation) => {
                            //     parsedDetails["affiliation"] = parsedDetails["affiliation"] +
                            //         affiliation.label + ', ';
                            // });


                            //parsedDetails["fieldOfStudy"] = entityDetails.fieldOfStudy[0].label;
